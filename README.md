...
This fork is maintained with documented release gates, auditable findings, and
evidence-based issue tracking. Start with the [engineering handbook](docs/engineering/README.md),
the [audit register](docs/engineering/audit-register.md), and [CONTRIBUTING.md](CONTRIBUTING.md).
