...
| ------------ | ------------------- | -------: | ----------------- | --------------------------------------------------------------------------------------------------------- | ------------- | ----------------------------------------------------------------------- |
| QLIE-AUD-001 | Verified defect     |       P0 | Runtime safety    | `UniversalMenu` manually destroys `menuName`, which is then destroyed automatically                       | Open          | [#6](https://github.com/Ensrick/QuickLootIE/issues/6)                   |
