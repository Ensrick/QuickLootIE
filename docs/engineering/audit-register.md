...
| ------------ | ------------------- | -------: | ----------------- | --------------------------------------------------------------------------------------------------------- | ------------- | ----------------------------------------------------------------------- |
| QLIE-AUD-001 | Verified defect     |       P0 | Runtime safety    | `UniversalMenu` manually destroys `menuName`, which is then destroyed automatically                       | Resolved      | [#6](https://github.com/Ensrick/QuickLootIE/issues/6)                   |
| QLIE-AUD-002 | Verified defect     |       P1 | Item actions      | Theft calculation checks the container owner instead of the resolved item owner                           | In review     | [#10](https://github.com/Ensrick/QuickLootIE/issues/10)                 |
...
| QLIE-AUD-007 | Verified defect     |       P2 | Input             | The post-1.6.1130 input context is immediately overwritten by the legacy value                            | In review     | [#15](https://github.com/Ensrick/QuickLootIE/issues/15)                 |
...
| QLIE-AUD-014 | Maintenance         |       P0 | Verification      | No automated behavior or runtime regression tests exist                                                   | In progress   | [#19](https://github.com/Ensrick/QuickLootIE/issues/19)                 |
